...
- **Minimize float → plugin chip bar** (plugin-owned overlay beside DataSync; works on stock CloudTAK without a host PluginPane patch): see [float-minimize-to-bottom-bar.md](./float-minimize-to-bottom-bar.md).
